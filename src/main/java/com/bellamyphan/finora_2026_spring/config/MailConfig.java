package com.bellamyphan.finora_2026_spring.config;
    ...
    public JavaMailSender javaMailSender() {
        ...
        for (String portStr : ports.split(",")) {
            try {
                ...
                mailSender.testConnection(); // If this fails, it jumps to catch block
                ...
                return mailSender; // Break the loop and return the working sender
            } catch (Exception e) {
